...
{
    [BurstCompile]
    public struct PlayerStateAndOffsetComponentGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<PlayerStateAndOffsetComponent>(),
                    ComponentSize = UnsafeUtility.SizeOf<PlayerStateAndOffsetComponent>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<PlayerStateAndOffsetComponent>(componentData, componentStride*i);
        ...
        private static void CopyFromSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<PlayerStateAndOffsetComponent>(componentData, componentStride*i);
                component.State = (int) snapshotBefore.State;
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<PlayerStateAndOffsetComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<PlayerStateAndOffsetComponent>(backupData, 0);
