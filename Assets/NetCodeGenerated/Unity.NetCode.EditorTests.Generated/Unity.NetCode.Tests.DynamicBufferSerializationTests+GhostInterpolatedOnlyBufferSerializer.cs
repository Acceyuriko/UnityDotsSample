...
{
    [BurstCompile]
    public struct UnityNetCodeTestsDynamicBufferSerializationTests_GhostInterpolatedOnlyBufferGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostInterpolatedOnlyBuffer>(),
                    ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostInterpolatedOnlyBuffer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostInterpolatedOnlyBuffer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostInterpolatedOnlyBuffer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostInterpolatedOnlyBuffer>(backupData, 0);
