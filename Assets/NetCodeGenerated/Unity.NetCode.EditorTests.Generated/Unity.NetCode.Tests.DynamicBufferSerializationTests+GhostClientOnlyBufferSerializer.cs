...
{
    [BurstCompile]
    public struct UnityNetCodeTestsDynamicBufferSerializationTests_GhostClientOnlyBufferGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostClientOnlyBuffer>(),
                    ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostClientOnlyBuffer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostClientOnlyBuffer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostClientOnlyBuffer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.DynamicBufferSerializationTests.GhostClientOnlyBuffer>(backupData, 0);
