...
{
    [BurstCompile]
    public struct UnityNetCodeTestsGhostGenTest_BufferGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                ...
                {
                    GhostFieldsHash = 13935174295727404769,
                    ExcludeFromComponentCollectionHash = 1,
                    ComponentType = ComponentType.ReadWrite<Unity.NetCode.Tests.GhostGenTest_Buffer>(),
                    ComponentSize = UnsafeUtility.SizeOf<Unity.NetCode.Tests.GhostGenTest_Buffer>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.GhostGenTest_Buffer>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.GhostGenTest_Buffer>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Unity.NetCode.Tests.GhostGenTest_Buffer>(backupData, 0);
        ...
        private static void CalculateChangeMask(IntPtr snapshotData, IntPtr baselineData, IntPtr bits, int startOffset)
        {
            ...
            uint changeMask;
            changeMask = (snapshot.IntValue != baseline.IntValue) ? 1u : 0;
            changeMask |= (snapshot.UIntValue != baseline.UIntValue) ? (1u<<1) : 0;
            changeMask |= (snapshot.BoolValue != baseline.BoolValue) ? (1u<<2) : 0;
